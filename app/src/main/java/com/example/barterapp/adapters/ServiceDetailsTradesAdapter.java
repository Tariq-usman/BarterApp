...
public class ServiceDetailsTradesAdapter extends RecyclerView.Adapter<ServiceDetailsTradesAdapter.ViewHolder> {
    Context context;
    List<String> trades;
    public ServiceDetailsTradesAdapter(Context context, List<String> trades) {
