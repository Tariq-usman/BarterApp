...
public class UserOffersReturnTradesAdapter extends RecyclerView.Adapter<UserOffersReturnTradesAdapter.ViewHolder> {
    Context context;
    List<String> trades;
    public UserOffersReturnTradesAdapter(Context context, List<String> trades) {
