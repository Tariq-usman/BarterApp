...
public class UserOffersTradesAdapter extends RecyclerView.Adapter<UserOffersTradesAdapter.ViewHolder> {
    Context context;
    List<String> trades;
    public UserOffersTradesAdapter(Context context, List<String> trades) {
