...
public class TradesHistoryResponse {

    @SerializedName("offerHistory")
    @Expose
    private List<OfferHistory> offerHistory = null;

    public List<OfferHistory> getOfferHistory() {
        return offerHistory;
    }

    public void setOfferHistory(List<OfferHistory> offerHistory) {
